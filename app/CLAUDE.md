...
> This file previously carried an incorrect note claiming the product had
> been renamed from "Nurse Notes" to "ClearChart." That was wrong — the
> product is, and has always been intended to be, **Nurse Notes**. All
> "ClearChart" references have been corrected throughout the app and docs.
>
